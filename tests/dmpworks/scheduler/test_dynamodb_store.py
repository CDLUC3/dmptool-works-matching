...
class TestPersistDiscoveredRelease:
    ...
    def test_new_release_is_persisted(self, dynamodb_release_table):
    ...
    def test_duplicate_is_noop(self, dynamodb_release_table):
...
class TestGetLatestKnownRelease:
    ...
    def test_returns_most_recent_record(self, dynamodb_release_table):
    ...
    def test_returns_none_when_no_records(self, dynamodb_release_table):
...
class TestDiscoverLatestRelease:
    ...
    def test_detector_returning_release_is_persisted(self, dynamodb_release_table):
    ...
    def test_detector_returning_none_is_noop(self, dynamodb_release_table):
...
class TestTaskRunRecord:
    ...
    def test_create_task_run(self, dynamodb_task_run_table):
        ...
        fetched = TaskRunRecord.get("ror-download", "20250101T060000-a1b2c3d4")
        assert fetched.status == "STARTED"

    def test_complete_task_run(self, dynamodb_task_run_table):
        ...
        set_task_run_status(run_name="ror-download", run_id="20250101T060000-a1b2c3d4", status="COMPLETED")

        record = TaskRunRecord.get("ror-download", "20250101T060000-a1b2c3d4")
        assert record.status == "COMPLETED"

    def test_fail_task_run(self, dynamodb_task_run_table):
        ...
        set_task_run_status(
            run_name="ror-download", run_id="20250101T060000-a1b2c3d4", status="FAILED", error="Container exited 1"
        )
    ...
    def test_fail_task_run_without_error(self, dynamodb_task_run_table):
        ...
        set_task_run_status(run_name="ror-download", run_id="20250101T060000-a1b2c3d4", status="FAILED")
...
class TestTaskCheckpointRecord:
    ...
    def test_set_task_checkpoint_writes_record(self, dynamodb_task_checkpoint_table):
    ...
    def test_get_task_checkpoint_returns_none_when_absent(self, dynamodb_task_checkpoint_table):
    ...
    def test_get_task_checkpoint_returns_record_after_set(self, dynamodb_task_checkpoint_table):
    ...
    def test_get_task_checkpoint_without_date_returns_latest(self, dynamodb_task_checkpoint_table):
    ...
    def test_get_task_checkpoint_without_date_returns_none_when_absent(self, dynamodb_task_checkpoint_table):
...
class TestUpdateReleaseStatus:
    ...
    def test_started_sets_status_and_execution_arn(self, dynamodb_release_table):
    ...
    def test_completed_sets_status(self, dynamodb_release_table):
    ...
    def test_failed_sets_status(self, dynamodb_release_table):
