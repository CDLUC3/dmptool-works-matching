...
class TestNSFFunderAPI:
    def test_fetch_award_publications(self):
    ...
    def test_extract_doi(self):
        assert extract_doi("DOI 10.1007/s00300-010-0947-0") == "10.1007/s00300-010-0947-0"
        assert extract_doi("DOI10.1007/s00300-010-0947-0") == "10.1007/s00300-010-0947-0"

    def test_fetch_org_id(self):
        with vcr.use_cassette(os.path.join(FIXTURES_FOLDER, "nsf_fetch_org_id.yaml")):
            assert nsf_fetch_org_id("2234213") == "EAR"
            assert nsf_fetch_org_id("0") is None
