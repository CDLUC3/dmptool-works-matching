...
dmpworks transform openalex-works "${SOURCES_DIR}/openalex_works" "${TRANSFORM_DIR}/openalex_works" --batch-size=4 --max-file-processes=4
dmpworks transform openalex-funders "${SOURCES_DIR}/openalex_funders" "${TRANSFORM_DIR}/openalex_funders"
