...
SELECT
  stats.doi,
  CASE
    WHEN cwm.abstract_length > stats.abstract_length THEN cwm.abstract
    WHEN cwm.abstract_length IS NOT NULL AND stats.abstract_length IS NULL THEN cwm.abstract
    ELSE oaw.abstract
  END AS abstract
